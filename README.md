...
* **Advanced Boundary Conditions:** Handles complex environmental interactions at the hot face, including imposed time-varying convective heat fluxes and linearized radiative cooling ($\varepsilon \sigma (T^4 - T_{inf}^4)$), alongside customizable cold-face boundary conditions (Robin convection or insulated).
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/BFG508/TESSERA.git](https://github.com/BFG508/TESSERA.git)
...
5. Run Thermal Analysis: * Execute `transientConduction_onelayer.mlx` to evaluate the ablative performance and thickness loss for different initial shield configurations.
