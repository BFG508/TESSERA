...
* **Advanced Boundary Conditions:** Handles complex environmental interactions at the hot face, including imposed time-varying convective heat fluxes and linearized radiative cooling $\varepsilon \sigma (T^4 - T^4_\infty)$, alongside customizable cold-face boundary conditions (Robin convection or insulated).
